...
Фактическое поведение текущей реализации, включая screen-off suspension BLE и OEM-ограничения Blackview/DokeOS, зафиксировано отдельно в [ограничениях платформы](platform-limitations.md).
